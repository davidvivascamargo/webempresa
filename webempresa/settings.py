...
#SECRET_KEY = "django-insecure-=fnlxtm78drkk-b@7(ak2@x6l%@ti9ru-f8sd#f-nr6egx*8ml"
SECRET_KEY = os.environ.get('SECRET_KEY', 'clave_insegura_por_defecto')
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://postgres:postgres@localhost:5432/dbname',
        conn_max_age=600
    )
}
